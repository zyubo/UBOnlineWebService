intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settings" type="Object">A set of key/value pairs that configure the Ajax request. All settings are Al. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) request.</summary>
    ///   <param name="settings" type="Object">A set of key/value pairs that configure the Ajax request. All settings are Al. A default can be set for any option with $.ajaxSetup().</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'ajaxPrefilter': function() {
    ...
    ///   <param name="dataTypes" type="String">An Al string containing one or more space-separated dataTypes</param>
  ...
  'ajaxSetup': function() {
    ...
    ///   <param name="options" type="Object">A set of key/value pairs that configure the default Ajax request. All options are Al.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'Callbacks': function() {
    ...
    ///   <param name="flags" type="String">An Al list of space-separated flags that change how the callback list behaves.</param>
    /// </signature>
  },
  'contains': function() {
    /// <signature>
...
intellisense.annotate(_object, {
  'always': function() {
    ...
    ///   <param name="alwaysCallbacks" type="Function">Al additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.</param>
  ...
  'done': function() {
    ...
    ///   <param name="doneCallbacks" type="Function">Al additional functions, or arrays of functions, that are called when the Deferred is resolved.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'fail': function() {
    ...
    ///   <param name="failCallbacks" type="Function">Al additional functions, or arrays of functions, that are called when the Deferred is rejected.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'isRejected': function() {
  ...
  'notify': function() {
    ...
    ///   <param name="args" type="Object">Al arguments that are passed to the progressCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'notifyWith': function() {
  ...
  'pipe': function() {
    ...
    ///   <param name="doneFilter" type="Function">An Al function that is called when the Deferred is resolved.</param>
    ///   <param name="failFilter" type="Function">An Al function that is called when the Deferred is rejected.</param>
    ///   <returns type="Promise" />
    /// </signature>
    /// <signature>
    ///   <summary>Utility method to filter and/or chain Deferreds.</summary>
    ///   <param name="doneFilter" type="Function">An Al function that is called when the Deferred is resolved.</param>
    ///   <param name="failFilter" type="Function">An Al function that is called when the Deferred is rejected.</param>
    ///   <param name="progressFilter" type="Function">An Al function that is called when progress notifications are sent to the Deferred.</param>
    ///   <returns type="Promise" />
    /// </signature>
  },
  'progress': function() {
  ...
  'reject': function() {
    ...
    ///   <param name="args" type="Object">Al arguments that are passed to the failCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'rejectWith': function() {
    ...
    ///   <param name="args" type="Array">An Al array of arguments that are passed to the failCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'resolve': function() {
    ...
    ///   <param name="args" type="Object">Al arguments that are passed to the doneCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'resolveWith': function() {
    ...
    ///   <param name="args" type="Array">An Al array of arguments that are passed to the doneCallbacks.</param>
    ///   <returns type="Deferred" />
    /// </signature>
  },
  'state': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'data': function() {
    /// <summary>An Al data map passed to an event method when the current executing handler is bound.</summary>
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'children': function() {
    /// <signature>
    ///   <summary>Get the children of each element in the set of matched elements, Ally filtered by a selector.</summary>
  ...
  'height': function() {
    ...
    ///   <param name="value" type="Number">An integer representing the number of pixels, or an integer with an Al unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS height of every matched element.</summary>
  ...
  'nextAll': function() {
    /// <signature>
    ///   <summary>Get all following siblings of each element in the set of matched elements, Ally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'off': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and Al namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".</param>
    ...
    /// <signature>
    ///   <summary>Remove an event handler.</summary>
    ///   <param name="events-map" type="Object">A map where the string keys represent one or more space-separated event types and Al namespaces, and the values represent handler functions previously attached for the event(s).</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching event handlers.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'on': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and Al namespaces, such as "click" or "keydown.myPlugin".</param>
    ...
    /// <signature>
    ///   <summary>Attach an event handler function for one or more events to the selected elements.</summary>
    ///   <param name="events-map" type="Object">A map in which the string keys represent one or more space-separated event types and Al namespaces, and the values represent a handler function to be called for the event(s).</param>
  ...
  'outerHeight': function() {
    /// <signature>
    ///   <summary>Get the current computed height for the first element in the set of matched elements, including padding, border, and Ally margin. Returns an integer (without "px") representation of the value or null if called on an empty set of elements.</summary>
  ...
  'parent': function() {
    /// <signature>
    ///   <summary>Get the parent of each element in the current set of matched elements, Ally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'parents': function() {
    /// <signature>
    ///   <summary>Get the ancestors of each element in the current set of matched elements, Ally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'prev': function() {
    /// <signature>
    ///   <summary>Get the immediately preceding sibling of each element in the set of matched elements, Ally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prevAll': function() {
    /// <signature>
    ///   <summary>Get all preceding siblings of each element in the set of matched elements, Ally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'siblings': function() {
    /// <signature>
    ///   <summary>Get the siblings of each element in the set of matched elements, Ally filtered by a selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'width': function() {
    ...
    ///   <param name="value" type="Number">An integer representing the number of pixels, or an integer along with an Al unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS width of each element in the set of matched elements.</summary>
