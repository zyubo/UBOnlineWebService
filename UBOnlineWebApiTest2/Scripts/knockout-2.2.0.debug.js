...
ko.utils = new (function () {
    ...
    return {
        ...
        stringifyJson: function (data, replacer, space) {   // replacer and space are Al
...
(function() {
    ...
    ko.toJSON = function(rootObject, replacer, space) {     // replacer and space are Al
...
ko.exportSymbol('jsonExpressionRewriting.insertPropertyAccessorsIntoJson', ko.expressionRewriting.preProcessBindings);(function() {
    ...
    var htmlTagsWithAllyClosingChildren = { 'ul': true, 'ol': true };
    ...
    ko.virtualElements = {
        ...
        normaliseVirtualElementDomStructure: function(elementVerified) {
            ...
            if (!htmlTagsWithAllyClosingChildren[ko.utils.tagNameLower(elementVerified)])
                return;
...
(function () {
    ...
    ko.applyBindings = function (viewModel, rootNode) {
        ...
        rootNode = rootNode || window.document.body; // Make "rootNode" parameter Al
...
(function() {
    ...
    //
    // Ally, template sources can also have the following functions:
